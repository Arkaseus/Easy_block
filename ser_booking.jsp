...
<div id="login-page">
  <div class="login">
    <h2 class="login-title">Service booking Form</h2>

    <form method="post" action="book_ser" >
 ...
 <br></br>     <label><b>Service name</b></label>
		         <input type='character' name="ser_name" placeholder="  Enter resource name">
