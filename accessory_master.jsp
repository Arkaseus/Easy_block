...
<div id="login-page">
  <div class="login">
    <h1 class="login-title">Accessory Master </h1>
    <p class="notice"></p>
  
      
      <a href="add_accessory.jsp"><button type="submit"><i class="fas fa-door-open"></i>Add</button></a>
      <a href="delete_accessory.jsp"><button type="submit"><i class="fas fa-door-open"></i>Delete</button></a>
